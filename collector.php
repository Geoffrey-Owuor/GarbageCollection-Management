...
<body>
    ...
    <ul>
     ...
     <li><a href="collectorLogout.php"><i class="fas fa-sign-out-alt"></i>Log Out </a> </li>   
    </ul>    
    </div>
                ...
                <table>
                 ...
                 <tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <th>Action</th> 
                        <td class="password-change"><a href="Cchange_password.php">Edit Password</a></td>
                     </tr>   
                    </tbody>
                </table>
            </div>
                    ...
                    <tbody>
                        ...
                        while($row = $result->fetch_assoc()){
                            echo 
                                ...
                                <td class='the-delete'><a href='confirm1.php?id=".$row['id']."'>Confirm</a></td>
                                </tr>";
                        }
                        ?>
