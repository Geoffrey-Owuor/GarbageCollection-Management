...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="adminLogout.php"><i class="fas fa-sign-out-alt"></i>Log Out</a> 
            </li>
        </ul>
    </div>
    <div class="main--content">
                ...
                <table>
                 <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                        <th>Action</th> 
                        <td class='password-change'><a href="Achange_password.php">Edit Password</a></td>
                     </tr>   
                    </tbody>
                </table>
            </div>
                    ...
                    <tbody>
                        ...
                        while($row = $result->fetch_assoc()){
                            echo 
                                ...
                                <td>".$row["email"]. "</td>
                                <td>".$row["date"]. "</td>
                                <td class='the-delete'><a href='delete1.php?user_id=".$row['user_id']."'>Delete</a></td>
                                </tr>";
                        }
                        ?>
        ...
        <div class="tabular--wrapper" id="theTrucks">
            ...
            <br>
            <div>
                <a class="collectorstyle" href="addTruck.php">Add Truck</a>
            </div>
            <br>
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        ...
                        while($row = $result->fetch_assoc()){
                            echo 
                                ...
                                <td class='the-delete'><a href='delete1.php?vehicle_id=".$row['vehicle_id']."'>Delete</a></td>
                                </tr>";
                        }
                        ?>
                    ...
                    <tbody>
                        ...
                        while($row = $result->fetch_assoc()){
                            echo 
                                ...
                                <td class='the-delete'><a href='assign.php?id=".$row['id']."'>Assign</a></td>
                                </tr>";
                        }
                        ?>
        ...
        <div class="tabular--wrapper" id="stark">
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        <?php 
                       $sql = "SELECT id, user_id, collector_id, vehicle_id, status, collection_date FROM orders where status='assigned'";
                        $result = $con->query($sql);
        ...
        <div class="tabular--wrapper" id="greaterReg">
            ...
            <br>
            <div>
                <a class="collectorstyle" href="collectorReg.php">Add Collector</a>
            </div>
            <br>
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        ...
                        while($row = $result->fetch_assoc()){
                            echo 
                                ...
                                <td class='the-delete'><a href='delete1.php?collector_id=".$row['collector_id']."'>Delete</a></td>
                                </tr>";
                        }
                        ?>
                    </tbody>
        ...
        <div class="tabular--wrapper" id="feedbacks">
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        <?php 
                        $sql = "SELECT reply_id, email, info, reply_status, reply FROM feedback";
                        $result = $con->query($sql);
                        ...
                        while($row = $result->fetch_assoc()){
                            echo 
                                ...
                                <td>".$row["reply"]. "</td>
                                <td class='the-delete'><a href='reply.php?reply_id=".$row['reply_id']."'>Reply</a></td>
                                </tr>";
                        }
                        ?>
                    </tbody>
