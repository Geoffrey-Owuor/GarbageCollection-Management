...
<body>
    ...
    <ul>
     ...
     <li><a href="order.php"><i class="fa-brands fa-first-order"></i>Order</a></li>
     <li><a href="feedback.php"><i class="fas fa-comments"></i>Feedback</a></li>
     <li><a href="userLogout.php"><i class="fas fa-sign-out-alt"></i>Log Out </a> </li>   
    </ul>    
    </div>
                ...
                <table>
                 ...
                 <tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <th>Action</th> 
                        <td class="password-change"><a href="change_password.php">Edit Password</a></td>
                     </tr>   
                    </tbody>
                </table>
            </div>
